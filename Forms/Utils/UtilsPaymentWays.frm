...
Private Sub Form_Activate()
    ...
    If Me.Tag = "True" Then
        Me.Tag = "False"
        AddColumnsToGrid grdUtilsPaymentWays, 25, GetSetting(strAppTitle, "Layout Strings", "grdUtilsPaymentWays"), "04NCNID,40NLNDescription", "ID,Περιγραφή"
        Me.Refresh
        PopulateGrid
    End If
    
    'AddDummyLines grdUtilsPaymentWays, "99999", "AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAΑΑΑΑΑΑΑΑΑΑ"
