...
Begin VB.Form UtilsSettings 
   ...
   Begin VB.Frame frmFrame 
      ...
      Begin UserControls.newText txtDestinationSite 
         ...
         EndProperty
      End
      Begin UserControls.newInteger mskSalesInvoiceLines 
         Height          =   465
         Left            =   4500
         TabIndex        =   10
         Top             =   450
...
Private Function LoadSettings()
    ...
    With rsParameters
        ...
        mskSalesInvoiceLines.text = !SalesInvoiceLines
...
Private Sub btnPanel_Click(Index As Integer)
    ...
    Select Case Index
        ...
        Case 2
            If cmdButton(1).Enabled Then
                If mskSalesInvoiceLines.Enabled Then mskSalesInvoiceLines.SetFocus
            End If
        'Καθολικές ρυθμίσεις
        Case 3
            If cmdButton(1).Enabled Then
...
Private Function ValidateFields()
    ...
    If DisplayMessage(1, 4, 1, "", mskSalesInvoiceLines.text) Then
        btnPanel_Click 2
        mskSalesInvoiceLines.SetFocus
        Exit Function
    End If
